...
public class FacturaExporterPDF {
    ...
    public FacturaExporterPDF(Factura factura){
    ...
    private void writeTableCabecera(PdfPTable table){
        ...
        cell.setPhrase(new Phrase(factura.getCliente().getNombre(), font));
        cell.setBorder(PdfPCell.NO_BORDER);
        table.addCell(cell);
        ...
        cell.setPhrase(new Phrase(factura.getCliente().getCif()));
        cell.setBorder(PdfPCell.NO_BORDER);
        table.addCell(cell);
        ...
        cell.setPhrase(new Phrase(factura.getCliente().getDireccion()));
        cell.setBorder(PdfPCell.NO_BORDER);
        table.addCell(cell);
        ...
        cell.setPhrase(new Phrase(factura.getCliente().getCp()
                                    +", "+factura.getCliente().getCiudad()
                                    +", "+factura.getCliente().getProvincia()
                                    +", "+ factura.getCliente().getPais()));
        cell.setBorder(PdfPCell.NO_BORDER);
        table.addCell(cell);
        ...
        cell.setPhrase(new Phrase(factura.getCliente().getTelefono()+" / "+ factura.getCliente().getTelefono2()));
        cell.setBorder(PdfPCell.NO_BORDER);
        table.addCell(cell);
        ...
        cell.setPhrase(new Phrase(factura.getCliente().getEmail()));
        cell.setBorder(PdfPCell.NO_BORDER);
        table.addCell(cell);
    ...
    private void writeTableDataAlbaranes(PdfPTable table){
        ...
        List<Albaran> albaranes = factura.getAlbaranes();
    ...
    public void export(HttpServletResponse response) throws IOException {
        ...
        if(factura.getCodigoFactura()!=null || factura.getCodigoFactura() != ""){
            Paragraph p1 = new Paragraph("FACTURA: " + factura.getCodigoFactura(), font);
            p1.setAlignment(Paragraph.ALIGN_CENTER);
            p1.setSpacingBefore(15);
            document.add(p1);
        }else{
            Paragraph p1 = new Paragraph("FACTURA: " + factura.getId(), font);
            p1.setAlignment(Paragraph.ALIGN_CENTER);
            p1.setSpacingBefore(15);
            document.add(p1);
        }
        ...
        Paragraph p3 = new Paragraph("Total: "+ factura.getTotal()+" €");
        p3.setAlignment(Paragraph.ALIGN_RIGHT);
        p3.setFont(FontFactory.getFont(FontFactory.HELVETICA_BOLD));
        document.add(p3);
